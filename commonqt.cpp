...
void
sw_add_classinfo_to_metaobject_builder(void* p, char* key, char* value) {
    QMetaObjectBuilder* builder = (QMetaObjectBuilder*)p;

    builder->addClassInfo(key, value);
}

void
sw_add_method_to_metaobject_builder(void* p, char* signature) {
    QMetaObjectBuilder* builder = (QMetaObjectBuilder*)p;
...
void
sw_delete_metaobject_builder(void* p)
{
    delete (QMetaObjectBuilder*)p;
}
